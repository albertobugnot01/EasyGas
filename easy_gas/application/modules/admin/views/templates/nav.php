<nav class="main-header sticky-top navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="position: fixed;"">
    ...
    <a href="<?php echo base_url("admin");?>" class="brand-link">
      <img src="<?php echo site_url("assets/images/easy.png");?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar ">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url("admin");?>" class="d-block"><?php echo ucfirst($this->session->userdata('name')) ?></a>
        </div>
      </div>
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="<?php echo base_url("admin/message/inbox");?>" class="nav-link">
